...
public class TextToLowercase{                                     // Creating Class "TextToLowercase" to convert text and compare strings
    ...
    public static String convertToLowerCase(String input) {         // taking string as a parameter 
    ...
    public static void main(String[] args) {
        ...
        String builtInLowerCase = userInput.toLowerCase();                   // using the built-in method  "input.toLowerCase()"

      
        String customLowerCase = convertToLowerCase(userInput);             // using the user-defined method

        // Compare the two uppercase strings using the user-defined method
        boolean areEqual = compare(builtInLowerCase, customLowerCase);

        // Display the results
        System.out.println("Result using built-in method: " + builtInLowerCase);
        System.out.println("Result using custom method: " + customLowerCase); 
